...
def get_current_user(
    ...
    """
    return _authenticate_user(request, authorization, db, create_if_missing=True)
...
def get_current_user_readonly(
    ...
    """Authenticate without mutating user state so read-only routes can use replicas."""
    return _authenticate_user(request, authorization, db, create_if_missing=False)
