...
- `market_date_today()` uses a static holiday set covering 2025-2027. The set must be refreshed annually by adding the next year's NYSE holiday schedule to `src/backtestforecast/utils/dates.py`.
