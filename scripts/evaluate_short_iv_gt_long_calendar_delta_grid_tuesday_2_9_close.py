...
_base.DEFAULT_SHORT_EXPIRATION_DTE_TARGETS = (2, 3)
_base.DEFAULT_LONG_EXPIRATION_DTE_TARGETS = (9, 10)
_base.DEFAULT_OUTPUT_PREFIX = ROOT / "logs" / "short_iv_gt_long_calendar_delta_grid_tuesday_2_9_close_2y"
