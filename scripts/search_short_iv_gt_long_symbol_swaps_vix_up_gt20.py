...
import scripts.evaluate_short_iv_gt_long_conditional_management_3weeks_vix_up_gt20 as _cond
...
_base.DEFAULT_BASELINE_LEDGERS = (
    LOGS / "short_iv_gt_long_conditional_management_vix_up_gt20_selected_trades.csv",
)
_base.DEFAULT_CHALLENGER_LEDGERS = (
    LOGS / "short_iv_gt_long_conditional_management_part2_vix_up_gt20_selected_trades.csv",
)
_base.DEFAULT_OUTPUT_CSV = LOGS / "short_iv_gt_long_swap_search_vix_up_gt20_orig112_vs_part2.csv"
