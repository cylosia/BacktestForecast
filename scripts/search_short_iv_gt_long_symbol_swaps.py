...
DEFAULT_BASELINE_LEDGERS = (
    LOGS / "short_iv_gt_long_conditional_management_lookback52warmup_to_2026-04-10_vix20abs_selected_trades.csv"
,
    LOGS / "short_iv_gt_long_conditional_management_part2_52weeks_vix20abs_selected_trades.csv",
)
...
DEFAULT_OUTPUT_CSV = LOGS / "short_iv_gt_long_swap_search_orig112_vs_part2.csv"
