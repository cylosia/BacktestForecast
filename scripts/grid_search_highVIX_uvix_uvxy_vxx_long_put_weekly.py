...
from run_highVIX_uvix_uvxy_vxx_long_put_weekly import (  # noqa: E402
    DEFAULT_DTE_TOLERANCE_DAYS,
    ...
    StrategyConfig,
    _build_bundle,
    _build_long_put_config,
    _build_store,
    _extract_long_put_strike_from_trade,
...
DEFAULT_OUTPUT_CSV = ROOT / "logs" / "highVIX_uvix_uvxy_vxx_long_put_weekly_grid.csv"
DEFAULT_OUTPUT_JSON = ROOT / "logs" / "highVIX_uvix_uvxy_vxx_long_put_weekly_grid.json"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Grid test the highVIX weekly long-put replay for UVIX, UVXY, and VXX, "
    ...
    parser.add_argument(
        ...
        help="Comma-separated long-put delta targets. Defaults to 30,40,50.",
    )
    parser.add_argument(
        "--profit-target-pcts",
