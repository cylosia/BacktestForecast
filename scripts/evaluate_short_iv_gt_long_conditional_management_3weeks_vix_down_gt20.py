...
def _only_vix_down_gt_threshold(
    *,
...
_base.DEFAULT_SELECTED_TRADES_CSV = LOGS / "short_iv_gt_long_best_delta_vix_down_gt20_selected_trades.csv"
_base.DEFAULT_OUTPUT_TRADES_CSV = LOGS / "short_iv_gt_long_conditional_management_vix_down_gt20_selected_trades.csv"
_base.DEFAULT_OUTPUT_SUMMARY_CSV = LOGS / "short_iv_gt_long_conditional_management_vix_down_gt20_summary.csv"
_base._is_vix_weekly_change_within_threshold = _only_vix_down_gt_threshold
_base.BEST_COMBINED_PORTFOLIO_POLICY_LABEL = _base.BEST_COMBINED_SOURCE_BASKET_CLOSE_70_POLICY_LABEL
