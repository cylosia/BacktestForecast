...
_register(
    ...
    StrategyCatalogEntry(
        ...
        short_description="Sell a near-term call and buy a longer-term call at the same strike.",
        category=StrategyCategory.MULTI_LEG,
        bias=StrategyBias.NEUTRAL,
        leg_count=2,
        min_tier=StrategyTier.PREMIUM,
    ...
    StrategyCatalogEntry(
        ...
        short_description="Sell a near-term put and buy a longer-term put at the same strike.",
        category=StrategyCategory.MULTI_LEG,
        bias=StrategyBias.NEUTRAL,
        leg_count=2,
        min_tier=StrategyTier.PREMIUM,
